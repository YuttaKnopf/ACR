...
def test_check_image(
    ...
    mock_get_image_data.assert_called_once_with("db", "images_path", "image_folder")
...
@patch("main.get_company_by_image_name", return_value="satellite_name")
@patch(
...
def test_get_image_data(
    ...
    mock_get_company_by_image_name,
    mock_get_tif_file,
    ...
    mock_get_tif_file.assert_called_once_with("images_path/image_folder")
    mock_get_company_by_image_name.assert_called_once_with("example_image.tif")
    mock_get_satellite_details.assert_called_once_with("db", "satellite_name")
...
def test_send_to_check_disruptions(
    ...
    send_to_check_disruptions("db", "image_path_example", "mongo_image_id_example")
    mock_blur_disruption.assert_called_once_with(
        "db", "image_path_example", "mongo_image_id_example"
    )
